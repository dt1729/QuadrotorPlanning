...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'se3ompl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dt/Classes-Fall22/Motion-Planning-Classes/Project/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dt/Classes-Fall22/Motion-Planning-Classes/Project/build/devel/lib;/home/dt/Classes-Fall22/Motion-Planning-Classes/RotorsSimul/devel/lib;/home/dt/StereoVision/src/ERC-Remote-Navigation-Sim/devel/lib;/opt/ros/noetic/lib)
